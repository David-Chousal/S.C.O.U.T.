...
| Record | Date | Summary |
|---|---|---|
| [`wedge-wall-thickness-structural-check-2026-09-07.md`](wedge-wall-thickness-structural-check-2026-09-07.md) | 2026-09-07 | Closed-form check of the v5 thinned wedge walls (outer 0.095 in / sides 0.063 in, 5.5 in height). **Both accepted** — the six wedges form an epoxied closed monocoque ring (60° each, epoxied seams, foamed after ring assembly). Internal bracing web mandatory (DFM). The epoxied ring is the primary structure; foam is required backing against local/asymmetric loads, mandatory before submersion pending an assembly-level ring-buckling FEA. Impact ([SCO-71](https://linear.app/scout1/issue/SCO-71)) still to check |
