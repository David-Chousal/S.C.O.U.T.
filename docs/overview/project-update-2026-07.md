...
- Waterproof electronics enclosure (4” Schedule 40 PVC)

- O-ring sealed removable end caps

- Modular turbidity sensor enclosure

- Heat-set inserts replacing embedded nuts for easier assembly

- Hull refinement for manufacturability and waterproofing

- Modular architecture supporting future expansion

#### Concepts Under Evaluation

- Vertical modular sensor string

- External cable routing

- Multi-depth temperature measurements

- Multi-depth turbidity measurements

- Optional hydrophones

- More hydrodynamic hull geometry to reduce flow and splash noise
...
|----|----|
| Coral reef monitoring buoy | Nearshore environmental monitoring platform |
...
Current concept: **modular vertical sensor string** (attached).

- Surface electronics enclosure (battery, communications, logging)

- 2–3 temperature sensors

- 2–3 turbidity sensors

- Optional hydrophone(s)

- External cable routing

- Modular, replaceable sensor nodes

This architecture enables multi-depth measurements while keeping the primary electronics enclosure sealed above the waterline, simplifying maintenance and future expansion.

## 5. Discussion Topics

- Does a modular sensor string offer advantages over buoy-integrated sensors?

- Should multi-depth temperature measurements become a primary objective?

- Should hydrophones remain an optional payload?

- Are there additional stakeholders or deployment scenarios we should consider?
...
- Keep **hydrophones optional** until their added complexity is justified.
