...
| Electrical design | 🟡 In progress | Build platform decided; Rev A KiCad schematic done for M0 + battery + 2 sensors (solar/hydrophone deliberately deferred); bring-up parts order in progress | Charging path ([ADR-0002](../decisions/0002-lifepo4-charging-path.md)), parts arrival ([SCO-88](https://linear.app/scout1/issue/SCO-88)) |
