...
| Fact | Canonical value | Source |
|---|---|---|
| LoRa frequency | **915 MHz** (US ISM band). ⚠️ **Compliance open:** the firmware uses a *single fixed* 915.0 MHz channel at 125 kHz / +14 dBm, which appears to satisfy neither 47 CFR §15.247 route (digital modulation needs ≥500 kHz; hopping needs ≥50 channels). Recommended fix is BW500 at SF11–SF12 — see [FCC 915 MHz Compliance](../research/fcc-915-mhz-compliance.md), not yet decided | [EDD](../engineering/engineering-design-document.md), [SCO-19](https://linear.app/scout1/issue/SCO-19) |
