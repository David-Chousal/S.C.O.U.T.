...
| Multi-depth string | ⚠️ **Contested, not re-decided here.** ADR-0003 says deferred, but mechanical is actively building a multi-depth sensor stem (2026-08-15), motivated by the stakeholder interviews. Needs a cross-discipline decision | [ADR-0003](../decisions/0003-single-point-sensing.md), [Sensor String Architecture](../engineering/sensor-string-architecture.md) |
