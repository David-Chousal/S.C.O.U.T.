...
| Biofouling mitigation product | Coating approach chosen over copper mesh/wipers; specific product open — reef-safe (copper-free, specialty supplier) vs. general-retailer (copper-based, Home Depot) tradeoff. See [Biofouling Antifouling Coatings](../research/biofouling-antifouling-coatings.md) | John Ryan (GENG) | [SCO-15](https://linear.app/scout1/issue/SCO-15) |
