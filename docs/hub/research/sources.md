...
| `adafruit-3178` | Adafruit. "Feather M0 with RFM95 LoRa Radio — 900 MHz" (PID 3178), product page + [learn guide](https://learn.adafruit.com/adafruit-feather-m0-radio-with-lora-radio-module). [link](https://www.adafruit.com/product/3178) | 🔓 | — | The build platform ([ADR-0001](../../decisions/0001-mcu-and-radio-selection.md)). **Open question:** Adafruit indicates an FCC-certified module since 2019, but no FCC ID appears in the published docs — if a modular grant exists, its conditions constrain permitted modem configurations ([SCO-19](https://linear.app/scout1/issue/SCO-19)) |
