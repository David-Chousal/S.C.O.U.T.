...
**Caveat / how to use it — the store-and-forward reframe.** S.C.O.U.T. keeps the **full record on local flash**,
...
LoRa-REP is LoRaWAN-specific (virtual nodes, ACK/downlink); S.C.O.U.T.'s raw P2P link should take only the
