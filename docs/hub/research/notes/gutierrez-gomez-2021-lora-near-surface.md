...
**Why it matters to S.C.O.U.T.** This is the propagation regime S.C.O.U.T.'s *buoy* actually lives in — an antenna
...
fine, but a low transmit antenna and marginal Fresnel-zone clearance are what will actually cap S.C.O.U.T.'s
...
with Jovalekić it defines the two ends of the range envelope S.C.O.U.T. must measure in Phase 4.
