...
**Why it matters to SCOUT.** SCOUT's radio (RadioHead `RH_RF95`) exposes the LoRa coding rate directly, so
this is a nearly free reliability dial. Because SCOUT transmits **one 82-byte packet per day**, airtime is
