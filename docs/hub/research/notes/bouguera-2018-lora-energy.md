...
**Why it matters to SCOUT.** This turns SCOUT's radio choices into numbers the power budget can use. It lets
...
**Caveat / how to use it.** The model is dominated by the radio; SCOUT's true budget must add the MCU wake,
