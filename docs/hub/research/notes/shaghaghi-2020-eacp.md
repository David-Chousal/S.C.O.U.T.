...
- **Citation:** Shaghaghi et al. (2020). ÂB / EACP — energy-aware communication protocol.
  *Venue and DOI to confirm.* Authored by S.C.O.U.T. faculty advisor **Navid Shaghaghi** — obtain
...
*(To write after reading.)* The protocol S.C.O.U.T. is adapting for the buoy ↔ shore link. Core idea
