...
- **Project:** every issue belongs to exactly one phase project (Phase 0–6). Phase 0 (Kickoff, Aug 14 – Sep 20) held the open design-alignment decisions and was **closed 2026-09-24**, its remaining open issues carried into Phase 1.
