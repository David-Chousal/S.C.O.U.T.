...
| **Canonical Facts** — new CAD tool split row added to the Mechanical & deployment table (Onshape for part geometry, Fusion 360 for assembly), resolving the flag from the meeting-notes mirror below | 2026-08-25 | Claude session, direct connector write |
