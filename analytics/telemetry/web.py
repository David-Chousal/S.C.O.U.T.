...
def render_html(
    ...
    *,
    ...
    body = (
        ...
        '<p class="data-links" style="color:var(--faint)">Thermal stress via NOAA Coral Reef '
        "Watch Degree Heating Weeks. Turbidity is uncalibrated — relative events, not NTU. "
        "Regenerated by the shore station from the buoy's LoRa telemetry.</p>"
        "</div></section>"
    )
