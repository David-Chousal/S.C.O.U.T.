...
CATALOG: tuple[Reef, ...] = (
    ...
    Reef("reef-flat", "sunlit", "Shallow reef flat", "Corals just beneath the surface",
         "A shallow coral reef flat just below the surface, Misool, Indonesia.",
         Photo(photographer="Alex Mustard", file="reef-flat.jpg")),
    Reef("green-turtle", "sunlit", "Green turtle", "A grazer over the shallow reef",
         "A green sea turtle gliding over a shallow reef, Great Barrier Reef, Australia.",
         Photo(photographer="Jordan Robins", file="green-turtle.jpg")),
    Reef("sponge-garden", "reef", "Sponge garden", "Elephant-ear sponges, Solomon Islands",
         "Magenta elephant-ear sponges on a reef, Solomon Islands.",
         Photo(photographer="Tracey Jennings", file="sponge-garden.jpg")),
    Reef("coral-bommie", "reef", "Coral bommie", "A reef outcrop alive with fish",
         "A coral bommie swarming with reef fish, Mayotte.",
         Photo(photographer="Gabriel Barathieu", file="coral-bommie.jpg")),
    Reef("anthias-swarm", "reef", "Anthias swarm", "Reef fish over the coral, Red Sea",
         "A cloud of orange anthias over a coral outcrop, Red Sea.",
         Photo(photographer="Renata Romeo", file="anthias-swarm.jpg")),
    Reef("anemonefish", "reef", "Anemonefish", "A clownfish in its host anemone",
         "A clownfish in its host anemone on a reef, Raja Ampat, Indonesia.",
         Photo(photographer="Dani Escayola", file="anemonefish.jpg")),
)
