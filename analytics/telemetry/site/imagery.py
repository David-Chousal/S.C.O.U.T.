...
def credits_page_body(img_dir: Path | None) -> str:
    ...
    authored_note = (
        ...
        "self-contained inline-SVG atmospheres generated by the site, not photographs, and so "
        "require no attribution.</p>"
        '<h2 style="margin-top:2.4rem">Typography</h2>'
        "<p>Set in <strong>DM Sans</strong> (Colophon Foundry &amp; Indian Type Foundry), "
    ...
    return (
        ...
        "Photographs are used only in the spirit of ocean conservation and education.</p>"
